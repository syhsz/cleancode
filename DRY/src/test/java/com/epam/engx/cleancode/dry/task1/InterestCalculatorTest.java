...
public class InterestCalculatorTest {
    ...
    private AccountDetails reduceStartDate(AccountDetails accountDetails) {
    ...
    private void assertInterest(AccountDetails accountDetails, double expected) {
        assertEquals(expected, new InterestCalculator().calculateInterest(accountDetails).doubleValue(), 0.00000001);
    }
